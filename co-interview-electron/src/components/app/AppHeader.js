...
export class AppHeader extends LitElement {
    ...
    async _checkForUpdates() {
        try {
            ...
            const response = await fetch('https://raw.githubusercontent.com/yongjiexue88/co-Interview/refs/heads/master/package.json');
    ...
    async _openUpdatePage() {
        ...
        await ipcRenderer.invoke('open-external', 'https://co-interview.com');
    }
    ...
    getViewTitle() {
        const titles = {
            onboarding: 'Welcome to Co-Interview',
            main: 'Co-Interview',
            customize: 'Customize',
            help: 'Help & Shortcuts',
            history: 'Conversation History',
            advanced: 'Advanced Tools',
            assistant: 'Co-Interview',
        };
