// Content extracted from interviewcoder.co
...
export const undetectableFeatures: Feature[] = [
    ...
    },
    {
        ...
        description: 'Even if the session is recorded, InterviewCoder leaves no visible windows or overlays.',
        icon: '📹'
    },
    {
        id: 'click-through',
        title: 'Completely Click-Through. Truly Invisible',
        description: 'Even when your cursor hovers or clicks on InterviewCoder, your system and apps won\'t detect it. No focus shifts. No flags. No traces.',
        icon: '🖱️'
    }
];
...
export const faqItems: FAQItem[] = [
    {
        ...
        answer: 'Yes, a free plan is available to test core functionality. The free tier has model and feature limits so you can confirm compatibility during the onboarding process before upgrading to the lifetime plan. This lets you try Interview Coder risk-free and see how it works with your setup.'
    },
    {
        question: 'What\'s the ROI of Interview Coder compared to failing interviews?',
        answer: 'The average software engineering salary increase from landing a FAANG job is $50,000-$150,000+. One successful interview pays for Interview Coder thousands of times over.'
    },
    {
        question: 'What are the 20+ advanced undetectability features?',
        answer: 'Interview Coder uses native OS-level APIs for invisibility, click-through windows, process hiding, screen share detection bypass, and more. Check our "How it works" page for the full technical breakdown.'
    },
    {
    ...
    {
        question: 'Does Interview Coder work with the latest versions of Zoom, Teams, and other platforms?',
    ...
    {
        question: 'Has anyone ever been caught using Interview Coder?',
        answer: 'No. Interview Coder has been used in thousands of interviews without a single detection. Our architecture makes it technically impossible for browser-based platforms to detect.'
    },
    {
        question: 'Is the lifetime deal really lifetime?',
        answer: 'Yes, one payment gives you permanent access to Interview Coder including all future updates and features.'
    }
];
...
export const testimonials: Testimonial[] = [
    {
        name: 'Anonymous User',
        company: 'Amazon',
        content: 'I got an offer from Amazon using Interview Coder. It helped me through both the OA and the final round.',
        verified: true
    },
    {
        name: 'Faizan Syed',
        content: 'Interview Coder is a game changer. The undetectability features are next level.',
        verified: true
    },
    {
        name: 'Anonymous User',
