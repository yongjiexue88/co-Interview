...
export const FEATURES: Feature[] = [
    {
        title: "Undetectable",
        description: "Designed with stealth in mind. Our overlay captures screen content without injecting code into the webpage DOM, making it virtually impossible for anti-cheat systems to detect.",
        icon: Shield
    },
    {
        title: "Supports All Sites",
        description: "Works seamlessly on LeetCode, HackerRank, CodeSignal, CodeWars, and any other web-based coding environment or interview platform.",
        icon: Globe
    },
    {
    ...
    },
    {
        ...
        description: "Don't just copy—understand. The AI explains the logic behind the solution so you can confidently explain it to your interviewer.",
        icon: Code2
    }
];
