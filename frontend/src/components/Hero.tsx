            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
                ...
                <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-24">
                    ...
                    <div className="relative group">
                        ...
                        <div className="absolute top-full left-0 mt-2 w-full bg-[#1a1a1a] border border-white/10 rounded-xl shadow-xl opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 z-50 overflow-hidden">
                            <a
                                ...
                                download
                                onClick={() => import('../lib/analytics').then(m => m.trackEvent('hero_download_click', { platform: 'mac-arm64' }))}
                            ...
                            <a
                                ...
                                download
                                onClick={() => import('../lib/analytics').then(m => m.trackEvent('hero_download_click', { platform: 'mac-x64' }))}
                    ...
                    <a
                        ...
                        download
                        onClick={() => import('../lib/analytics').then(m => m.trackEvent('hero_download_click', { platform: 'windows' }))}
