            ...
            <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="space-y-4">
                    {faqItems.map((item, index) => (
                        <div key={index} className="bg-[#1a1a1a] border border-white/5 rounded-xl overflow-hidden">
                            <button
                ...
                <div className="mt-12 text-center">
                    ...
                    <a href="mailto:support@co-interview.com" className="inline-flex items-center gap-2 text-[#FACC15] hover:underline">
