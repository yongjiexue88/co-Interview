...
This repository is a fork of [`cheating-daddy`](https://github.com/sohzm/cheating-daddy), now renamed to Co-Interview.
...
Pull requests from <https://github.com/sohzm/cheating-daddy> (the original upstream) are commonly
