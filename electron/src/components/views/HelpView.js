            ...
            <div class="help-container">
                <div class="option-group">
                    ...
                    <div class="community-links">
                        <div class="community-link" @click=${() => this.handleExternalLinkClick('https://co-interview.com')}>
                            <svg
                                viewBox="0 0 24 24"
                                fill="none"
                                stroke="currentColor"
                        ...
                        <div class="community-link" @click=${() => this.handleExternalLinkClick('https://github.com/yongjiexue88/co-Interview')}>
                            <svg
                                viewBox="0 0 24 24"
                                fill="none"
                                stroke="currentColor"
